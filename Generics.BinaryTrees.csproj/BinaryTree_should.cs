...
namespace Generics.BinaryTrees
{
	...
	public class BinaryTree_should
	{
		...
		[Test]
		public void InitializeFromAnArrayAndSort3()
		{
			var tree = BinaryTree.Create(2, 4, 1, 7, 4, 4, 3, 9, 5, 6, 4, 8, 6, 6);
			CollectionAssert.AreEqual(new[] { 1, 2, 3, 4, 4, 4, 4, 5, 6, 6, 6, 7, 8, 9 }, tree);
		}
